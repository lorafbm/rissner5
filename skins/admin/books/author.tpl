<div class="wgoods">
    <h4><?php if ($res->num_rows){ echo 'У нас '.$res->num_rows.' книги автора '.hsc($_GET['keya']) ; } ?>:</h4>
    <?php if (isset($inf)){ ?>
    ...
    <p><a href="/admin/books/fulldesc/<?php echo (int)$value['id']; ?> "class="kpn"><?php echo hsc($value['description']); ?></a></p>
