    ...
    <form action="" method="post" >
        <table class="users">
            ...
            <tr>
                ...
                <td><a href="/admin/books/cat?action=delete&id=<?php echo (int)$row['id']; ?>" class="inna" onclick="return del();">Удалить</a></td>
                <td><a href="/admin/books/editcat?id=<?php echo (int)$row['id']; ?>" class="inn">Редактировать</a></td>
