<div class="wgoods">
    ...
    <?php if ($auth->num_rows){ echo '<p class="game">У нас '.$auth->num_rows.' авторов:</p>';
    } else { echo '<p class="game">У нас пока нет авторов.</p> '; } ?>
        <?php if (isset($inf)){ ?>
        <p class="goods"><?php echo $inf;?></p>
        <?php } ?>
    <?php if (isset($error)){echo $error;}?>
    <form action="" method="post" >
        <p class="gamel">Добавить автора<input type="text" name="add" class="delete">
    ...
    <form action="" method="post">
        <table class="users">
            ...
            <tr>
                ...
                <td><a href="/admin/books/main?action=delete&id=<?php echo (int)$row['id']; ?>" class="inna" onclick="return del();">Удалить</a></td>
                <td><a href="/admin/books/editauth?id=<?php echo (int)$row['id']; ?>" class="inn">Редактировать</a></td>
